...
const graph: RoadGraph = {
  ...
  edges: [
    { id: 0, from: 0, to: 1, points: [[0, 0, 0], [100, 0, 0]], lengthM: 100, surface: "tarmac", roadClass: "residential", lanes: 2, widthM: 6, oneway: true, speedLimitKph: 50, bridge: false, tunnel: false, layer: 0, osmWayId: 0 },
    { id: 1, from: 1, to: 2, points: [[100, 0, 0], [0, 0, 100]], lengthM: 10, surface: "gravel", roadClass: "track", lanes: 1, widthM: 4, oneway: true, speedLimitKph: 30, bridge: false, tunnel: false, layer: 0, osmWayId: 1 },
    { id: 2, from: 0, to: 2, points: [[0, 0, 0], [0, 0, 100]], lengthM: 500, surface: "tarmac", roadClass: "residential", lanes: 2, widthM: 6, oneway: false, speedLimitKph: 50, bridge: false, tunnel: false, layer: 0, osmWayId: 2 },
  ],
};
